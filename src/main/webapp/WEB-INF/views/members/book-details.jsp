...
<title>T7 ClubHouse: My Booking History</title>
</head>
<body>
<a href="${pageContext.request.contextPath}/members/welcome"><div class="btn btn-warning"><i class="fa fa-home"></i>HOME</div></a><br/><br/>

<h3><center>Booking History</center></h3>
<table  border="1" align="center" class="table table-striped thead-dark">
		<thead>
