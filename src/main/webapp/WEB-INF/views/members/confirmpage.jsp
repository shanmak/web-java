...
<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
  <title>
    T7 ClubHouse Members: Facility Booking Confirmation
  </title>
...
<body>
	...
	<div class ="col-12 pr-5" style="text-align: right;"><a href="${pageContext.request.contextPath}/members/mybooking"><span class="btn btn-outline-warning">VIEW BOOKINGS</span></a></div>
	</div></div></div>
	</form>
