...
<body><div class ="bodycontainer">
	...
	<aside>
		...
		<div>
			<p id="intro-signup" class="active">
	...
	<section>
		...
		<form id="form-signup" method="post" modelAttribute="userForm" action="registration" class="needs-validation active">
			...
			<div class="form-group">
				...
				<fieldset>
					<div>
						<label for="username">Username</label> <input id="userName" name="userName" type="text"
							placeholder="username" value="${refilluser.getUserName()}" required />
					</div>	
				...
				<fieldset>
					<div>
						...
						type="text" placeholder="Jane" value="${refilluser.getFirstName()}" required />
					</div>
				</fieldset>
				<fieldset>
					<div>
						<label for="name">Last Name</label> <input id="lastName" name="lastName"
							 type="text" placeholder="Smith" value="${refilluser.getLastName()}" required />
					</div>
				</fieldset>
				<fieldset>
					<div>
						<label for="email">Email</label> <input id="email" name="email" type="email"
							placeholder="janesmith@email.com" value="${refilluser.getEmail()}" required />
					</div>
				</fieldset>
				<fieldset>
					<div>
						<label for="address">Address</label> <input id="address" name = "address"
							type="text" value="${refilluser.getAddress()}" placeholder="Address" />
					</div>
				</fieldset>
				<fieldset>
					<div>
						<label for="mobile">Contact No.</label> <input id="contactNumber" name="contactNumber"
							type="text" placeholder="91234567" value="${refilluser.getContactNumber()}"pattern="^[0-9]{8}$"
